...
function mapOrder(row, history, images, profileMap = new Map()) {
  return {
    ...
    supplierOrderDate: row.supplier_order_date || "",
    supplierDeliveryDate: row.supplier_delivery_date || "",
    driver: row.driver || "",
...
function orderToRow(record) {
  return {
    ...
    supplier_order_date: record.supplierOrderDate || null,
    supplier_delivery_date: record.supplierDeliveryDate || null,
